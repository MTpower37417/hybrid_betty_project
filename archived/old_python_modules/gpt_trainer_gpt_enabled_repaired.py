...
class EmotionAnalyzer:
    ...
    def use_gpt_for_emotion(self, text: str) -> Dict[str, Any]:
        ...
        if self.gpt_controller.is_gpt_enabled():
            from call_gpt_betty_identity_fixed import call_gpt
            call_gpt(user_input, context)
            try:
            ...
            self.betty_trainer.fallback_to_local_response(user_input)
...
class MemoryCapsuleManager:
    ...
    def use_gpt_to_create_memory_capsule(
        ...
        if self.gpt_controller.is_gpt_enabled():
            from call_gpt_betty_identity_fixed import call_gpt
            response = call_gpt(user_input, context)
            try:
